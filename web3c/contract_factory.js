 ...
 * @param   {Function} completion is the completion block to perform at the end of the
 *          returned constructor function's exectuion. Used to extend the behavior here.
 */
function make(web3, provider, completion) {
  ...
  // Call the completion block to allow this method to be extended.
  completion();
}
