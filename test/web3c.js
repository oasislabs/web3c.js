...
describe('Web3', () => {
  ...
  it('should support making encrypted calls', async () => {
    let provider = new web3.providers.HttpProvider('http://localhost:' + serverPort);
    let inst = new web3c(provider);
    ...
    let contract = inst.confidential.Contract(
      ...
      //from address (note: this should be the to address not the from address)
      '0x62f5dffcb1C45133c670C7786cD94B75D69F09e1',
      {
