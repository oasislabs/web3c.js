...
const OASIS_DEPLOY_HEADER_ADDRESS = '0x2222222222222222222222222222222222222222';
...
const OASIS_DEPLOY_HEADER_EXPIRY = 12343333;

const OASIS_DEPLOY_HEADER_PLAINTEXT_ADDRESS = '0x5555555555555555555555555555555555555555';
const OASIS_DEPLOY_HEADER_PLAINTEXT_GAS = '0x1234';
const OASIS_DEPLOY_HEADER_PLAINTEXT_TX_HASH = '0xaaaaaa5f3564e8b30262fb931988888bbb203692bba9763a45c61b25ce531840';
const OASIS_DEPLOY_PLAINTEXT_TX_RECEIPT = JSON.parse(JSON.stringify(CONFIDENTIAL_DEPLOY_TX_RECEIPT));
OASIS_DEPLOY_PLAINTEXT_TX_RECEIPT.contractAddress = '0x5e0c135583ad36933ec1b36e8d034b15b747dd00';

const OASIS_PLAINTEXT_TX_HASH = '0xaaaaaa5f3564e8b30262fb931988888bbb203692bba9763a45c61b25ce531000';
const OASIS_PLAINTEXT_TX_RECEIPT = JSON.parse(JSON.stringify(CONFIDENTIAL_DEPLOY_TX_RECEIPT));
OASIS_PLAINTEXT_TX_RECEIPT.transactionHash = OASIS_PLAINTEXT_TX_HASH;
...
module.exports = {
  ...
  OASIS_DEPLOY_HEADER_ADDRESS,
  OASIS_DEPLOY_HEADER_GAS,
  OASIS_DEPLOY_HEADER_TX_HASH,
  OASIS_DEPLOY_TX_RECEIPT,
  OASIS_DEPLOY_HEADER_EXPIRY,
  OASIS_DEPLOY_HEADER_PLAINTEXT_ADDRESS,
  OASIS_DEPLOY_HEADER_PLAINTEXT_TX_HASH,
  OASIS_DEPLOY_PLAINTEXT_TX_RECEIPT,
  OASIS_PLAINTEXT_TX_HASH,
  OASIS_PLAINTEXT_TX_RECEIPT
};
